...
CREATE SEQUENCE SEQ_voard_bno INCREMENT BY 1 START WITH 1;
...
CREATE OR REPLACE TRIGGER TRI_voard_bno BEFORE INSERT ON voard
FOR EACH ROW
BEGIN
	SELECT SEQ_voard_bno.nextval
	INTO :new.bno
	FROM dual;
END;
